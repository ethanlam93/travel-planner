...
const SearchFlight = (props) => {
  ...
  const [
    showAdditionalFlightInformation,
    setShowAdditionalFlightInformation,
  ] = useState(false);
  ...
  const handleOriginDestinationSubmit = async (event) => {
    ...
    const originIataCode = await amadeus.referenceData.locations.get({
  ...
  const flightSearchSubmit = async (event) => {
    ...
    if (inputs.typeOfTrip === "Round Trip") {
      ...
      flights = await amadeus.shopping.flightOffersSearch.get({
        ...
        <div className="card horizontal searchBox">
          <div className="card-stacked">
            <div className="card-content">
              ...
              <form onSubmit={handleOriginDestinationSubmit}>
                ...
                <label>
                  ...
                  <Select
                    ...
                    name="typeOfTrip"
                    options={typeOfTrip}
                    onChange={handleTypeOfTripChange}
                  />
                </label>
                <button
                  style={{
              ...
              <br />
              <form
                onSubmit={flightSearchSubmit}
                style={{
                  display: showAdditionalFlightInformation ? "block" : "none",
                }}
              >
                <input
                  required
                  ...
                  name="adults"
                  className="adults"
                  placeholder="How many adults will be traveling?"
                  onChange={handleInputs}
                ></input>
                <input
                  required
                  ...
                  name="children"
                  className="children"
                  placeholder="How many children will be traveling?"
                  onChange={handleInputs}
                ></input>
                <br />
                <label>
            ...
            <div key={i} className="card blue-grey darken-1">
              <div className="card-content white-text">
                <span className="card-title">
                  <img className="airline-logo" src={airlineImg}></img>
                </span>
                {flight.itineraries[0].segments.map((flight) => {
                  return (
                    <>
                      <h6>
                        Flight from {flight.departure.iataCode} to{" "}
                ...
                <span
                  style={{ display: tripType ? "block" : "none" }}
                ...
                <br></br>
                <h6>
                  Price per ticket: ${flight.travelerPricings[0].price.total}
                </h6>
